...
Cada certificado é gerado com base em uma linha do CSV, ou seja: um arquivo com 100 linhas resulta em 100 PDFs, cada um contendo suas respectivas informações, como nome do aluno, cpf, curso, escola, data e nome do professor, todas essas informações são variáveis alimentadas pelo CSV.
